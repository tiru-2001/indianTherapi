const termsAndCondition = [
  ...
  {
    point:
      "This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://indiatherapist.com/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').",
  },
  {
    point:
      "The Platform is owned by NEO HAPPYLYF MIND CARE FOR U PRIVATE LIMITED, a company incorporated under the Companies Act, 1956 with its registered office at 3 180 Marichettihalli VILLPO Krishnagiri TK,Marichettihalli,Pochampalli,Krishnagiri-635204,Tamil Nadu ,Dharmapuri ,India(hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our')..",
  },
  {
    point:
  ...
  },
  {
    ...
    subpoint: [
      ...
      'All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Dharmapuri and Tamil Nadu.',
...
const refund = [
  `Cancellations will only be considered if the request is made 1 days of placing the order. However, 
...
product is out for delivery. In such an event, you may choose to reject the product at the doorstep.`,
  `NEO HAPPYLYF MIND CARE FOR U PRIVATE LIMITED does not accept cancellation 
requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be 
made if the user establishes that the quality of the product delivered is not good.`,
...
please refer the issue to them.`,
  `In case of any refunds approved by NEO HAPPYLYF MIND CARE FOR U PRIVATE 
LIMITED, it will take 3 days for the refund to be processed to you.`,
];

export { termsAndCondition, privacyPolicy, refund };
